...
class DataTransformation:
    ...
    def get_data_transformer_object(csl) -> Pipeline:   #cls means class method
        """
        ...
        try:
             imputer: KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)    # ** means unpacking the dictionary or key value pair
             logging.info(
                  f'Initliazed KNN imputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}'
                )
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
         logging.info('Entred the initiate data transformation method of DataTransformation class')
         try:
